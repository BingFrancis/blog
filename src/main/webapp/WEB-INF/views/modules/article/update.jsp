...
<script type="text/javascript">
    ...
    function save() {
        ...
        $.ajax({
            ...
            data: {"id":id,"title":title,"content":content,"summary":summary,"img_url":img_url},
            async: false,
...
<div style="position: relative">
    ...
    <%--<form id="saveForm" class="layui-form" method="post" style="padding-top: 0px">--%>
        ...
        <div class="layui-form-item" style="width: 80%; padding-left: 2%;margin-bottom: 0px;height: 44px">
            <input id="article_id" style="display: none" value="${details.id}">
            <input class="title" type="text" name="title" id="title"
                   placeholder="文章标题" value="${details.title}">
            <%--<button>返回首页</button>--%>
        </div>

        <div class="col-sm-12" name="article-editormd" id="article-editormd">

            <textarea name="content" id="content" style="display:none;"> ${details.content}</textarea>
        </div>
        ...
        <div>
            ...
            <button class="layui-btn layui-btn-fluid layui-bg-black" onclick="save()">更新并发布</button>
        </div>
    <%--</form>--%>
