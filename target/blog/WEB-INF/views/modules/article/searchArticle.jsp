...
<div class="container">
    ...
    <h1 class="mt-4 mb-3">Blog Search
        <%--<small>Home</small>--%>
    </h1>
    ...
    <div class="row">
        ...
        <!-- Blog Entries Column -->
        <div class="col-md-8">
            <c:forEach items="${searchList.list}" var="artilce">
                <div class="card mb-4">
            ...
            <div class="row">
                <div class="col-md-6">
                    第${searchList.pageNum}页，共${searchList.pages}页，共${searchList.total}条记录
                </div>
                <div class="col-md-6 offset-md-4" style="width: 100%;margin-left: 25%">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination pagination-sm mb-4 ">
                            <li class="page-item"><a class="page-link" href="${ctx}/article/search?page=1&&keyword=${keyword}">首页</a>
                            </li>
                            <c:if test="${searchList.hasPreviousPage}">
                                <li class="page-item"><a class="page-link"
                                                         href="${ctx}/article/search?page=${searchList.pageNum-1}&&keyword=${keyword}">上一页</a>
                                </li>
                            </c:if>
                            <c:forEach items="${searchList.navigatepageNums}" var="page">
                                <c:if test="${page==searchList.pageNum}">
                                    <li class="page-item active"><a class="page-link" href="${ctx}/article/search?page=${page}&&keyword=${keyword}">${page}</a></li>
                                </c:if>
                                <c:if test="${page!=searchList.pageNum}">
                                    <li class="page-item"><a class="page-link"
                                                             href="${ctx}/article/search?page=${page}&&keyword=${keyword}">${page}</a>
                                    </li>
                                </c:if>
                            </c:forEach>
                            <c:if test="${searchList.hasNextPage}">
                                <li class="page-item"><a class="page-link"
                                                         href="${ctx}/article/search?page=${searchList.pageNum+1}&&keyword=${keyword}">下一页</a>
                                </li>
                            </c:if>
                            <li class="page-item"><a class="page-link"
                                                     href="${ctx}/article/search?page=${searchList.pages}&&keyword=${keyword}">末页</a>
                            </li>
                        </ul>
                    </nav>
                </div>
